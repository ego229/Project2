...
const { electronicRouter } = require('./controllers/electronic.js')
const { inStockRouter } = require('./controllers/inStock.js')
...
/* Step 3.c
 *
 * use the `./public` electronicy to host static resources such as css and
 * image files
 */
